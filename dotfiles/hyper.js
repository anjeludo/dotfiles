...
hyperBorder: {
   ...
   fontFamily: '"FuraCode Nerd Font", "Hack Nerd Font", "Ubuntu Mono derivative Powerline", DejaVu Sans Mono for Powerline,Menlo, "DejaVu Sans Mono", Consolas, "Lucida Console", monospace', 
//fontFamily: '"Terminess Powerline", "Anonymice Powerline", "Roboto Mono for Powerline", "Meslo LG S for Powerline", "DejaVu Sans Mono", "Lucida Console", monospace',
  ...
  //   `@company/project`
  //   `project#1.0.1`
  plugins: ['hyper-statusline', 'hyperborder'],
